...
local data = {
	official_cn = readlist("4.3/simp_chinese", { ["_english"] = "_simp_chinese" }),
	cloudwu_cn = readlist "4.2/chinese",
	en_last = readlist "4.2/english",
	en_current = readlist "4.3/english",
}
...
local function output(data)
	local list = filelist.filelist (root .. "4.3/english/")
